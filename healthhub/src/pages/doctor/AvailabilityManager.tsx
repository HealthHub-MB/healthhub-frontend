...
// // //const payload = { startTime, endTime, activeDays };
// //   const token = localStorage.getItem('token')
// //   setLoading(true);
// //   try {
// //     const payload = { startTime, endTime, activeDays };
// //     await axios.post("http://localhost:8080/doctors/availability", payload,{
// //       headers : {
...
// //         {daysOfWeek.map((day) => (
// //           <div key={day} className="flex-row items-center w-[928px] h-[48px] opacity-100 pt-3 pb-3 gap-3 flex">
// //             <input
// //               type="checkbox"
// //               id={day}
...
// //       {/* Save Button */}
// //          <div className="flex justify-end items-end w-full h-[64px]">
// //  <Button
// //   type="button"
...
//     const token = localStorage.getItem("token");
//     //const doctorId = localStorage.getItem("userid"); // ✅ ensure this exists
//     const payload = {startTime, endTime, activeDays };
...
//     setLoading(true);
//     try {
//       const res = await axios.post("http://localhost:8080/doctor/availability", payload, {
//         headers: {
//           Authorization: `Bearer ${token}`,
...
//           {/* Start Time */}
//           <div className="flex flex-wrap items-end p-3 gap-4 w-[480px]">
//             <div className="flex flex-col w-[448px] h-[88px]">
//               <label className="pb-2 text-base font-medium text-[#121417]">
//                 Start Time
//               </label>
//               <input
//                 type="time"
...
//               <div
//                 key={day}
//                 className="flex-row items-center w-[928px] h-[48px] pt-3 pb-3 gap-3 flex"
//               >
//                 <input
//                   type="checkbox"
//                   id={day}

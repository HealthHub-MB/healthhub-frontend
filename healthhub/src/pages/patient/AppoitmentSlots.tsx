...
// // // // const AppoitmentSlots = () => {
// // // //   return (
// // // //     <div>AppoitmentSlots</div>
// // // //   )
// // // // }
...
// // //   useEffect(() => {
// // //     axios.get('http://localhost:8080/api/doctors/22/profile')
// // //       .then((res) => setDoctor(res.data.data))
// // //       .catch((err) => console.error(err));
// // //   }, []);

// // //   const getWeekDay = (dateStr: string) => format(new Date(dateStr), 'EEEE').toLowerCase();
...
// // //             />
// // //             <div>
// // //               <h1 className="text-2xl font-bold">Dr. {doctor.userId.fullName}</h1>
...
// // //               <p><strong>Address:</strong> {doctor.officeAddress}</p>
// // //             </div>
// // //           </div>
...
// // //                           selectedSlot?.id === slot.id ? 'bg-blue-500 text-white' : 'hover:bg-blue-100'
// // //                         }`}
...
// const AppoitmentSlots: React.FC = () => {
//   const { doctorId } = useParams(); // from route /doctors/:doctorId/profile
//   const [doctor, setDoctor] = useState<Doctor | null>(null);
//   const [selectedDate, setSelectedDate] = useState<string>('');
//   const [selectedSlot, setSelectedSlot] = useState<Slot | null>(null);
...
//     if (!selectedDate || !doctor) return [];
//     const weekDay = getWeekDay(selectedDate);
//     return doctor.slots.filter((slot) => slot.weekDay === weekDay && !slot.isBooked);
//   };
...
//             <span>Find a Doctor</span> / <span className="text-black font-medium">Dr. {doctor.userId.fullName}</span>
//           </div>
...
//             {selectedDate && (
//               <div className="mb-6">
//                 <h3 className="font-semibold mb-2 text-sm">Available Time Slots</h3>
//                 <div className="flex flex-wrap gap-3">
//                   {getAvailableSlots().length > 0 ? (
//                     getAvailableSlots().map((slot) => (
//                       <button
...
//                           selectedSlot?.id === slot.id ? 'bg-blue-600 text-white' : 'hover:bg-blue-100'
//                         }`}
//                         onClick={() => setSelectedSlot(slot)}
//                       >
//                         {slot.startTime.slice(0, 5)} - {slot.endTime.slice(0, 5)}
          ...
          <>
            ...
            <div className="mb-10">
                    ...
                    {getAvailableSlots().length > 0 ? (
                      getAvailableSlots().map((slot) => (
                        <button
                          ...
                          style={selectedSlot?.id === slot.id ? { backgroundColor: '#94C2F0' } : {}}
              ...
              <button
                ...
                className=" text-white px-6 py-2 rounded text-sm disabled:opacity-80"
                  style={{ backgroundColor: "#94C2F0" }}
              >
                Request an Appointment
              </button>
